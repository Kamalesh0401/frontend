...
// Schema (make agreeToTerms required so it's boolean, not boolean | undefined)
const schema = yup
  .object({
...
// Infer the form type from the schema to keep TS happy
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <Button
                variant="outline"
                onClick={() => toast('Google signup would be implemented here')}
              >
              ...
              <Button
                variant="outline"
                onClick={() => toast('Facebook signup would be implemented here')}
              >
