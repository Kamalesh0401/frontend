            ...
            >
                <div className="bg-white rounded-2xl shadow-xl p-8">
                    ...
                    <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                        ...
                        <p className="text-sm text-blue-700">Email: demo@funjok.com</p>
                    ...
                    <div className="mt-6">
                        ...
                        <div className="mt-6 grid grid-cols-2 gap-3">
                            <Button
                                variant="outline"
                                onClick={() => toast('Google login would be implemented here')}
                            >
                            ...
                            <Button
                                variant="outline"
                                onClick={() => toast('Facebook login would be implemented here')}
                            >
